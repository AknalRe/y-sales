  ...
  return (
    <main className="settings-page">
      <div className="settings-hero">
        <div>
          <p className="settings-kicker"><SlidersHorizontal size={15} /> Operational Rules</p>
          <h1>Pengaturan Operasional</h1>
          <p>Atur validasi visit, radius outlet, GPS, bukti transaksi, dan face verification untuk company ini.</p>
        </div>
        <button onClick={handleSave} disabled={saving} className="admin-btn admin-btn-primary" type="button">
