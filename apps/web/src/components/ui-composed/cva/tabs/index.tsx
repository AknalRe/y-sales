...
type TabsAppearance = "default" | "underline" | "ghost" | null | undefined;

type TabsRootProps =
  React.ComponentProps<typeof BaseTabs.Tabs.Root>;

type TabsListProps =
  React.ComponentProps<typeof BaseTabs.Tabs.List> &
  VariantProps<typeof tabList>;

type TabsTabProps =
  React.ComponentProps<typeof BaseTabs.Tabs.Tab> &
  VariantProps<typeof tab>;

type TabsIndicatorOrientation = "row" | "col";

type TabsIndicatorProps =
  React.ComponentProps<typeof BaseTabs.Tabs.Indicator> &
  VariantProps<typeof indicator> & {
    orientation?: TabsIndicatorOrientation;
  };

type TabsPanelProps =
  React.ComponentProps<typeof BaseTabs.Tabs.Panel>;

/* ====================
   Context
==================== */

const TabsAppearanceContext =
  React.createContext<TabsAppearance>("default");
...
function TabsTab({
  ...
  const ctxAppearance =
    React.useContext(TabsAppearanceContext);

  const finalAppearance =
    appearance ?? ctxAppearance;
...
function OverviewIcon(props: React.ComponentProps<"svg">) {
  return (
    <svg
      ...
      fill="currentcolor"
      {...props}
      className={cn(iconCva(), props.className)}
    >
