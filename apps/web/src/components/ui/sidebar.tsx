  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "transition-[width] duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] relative w-(--sidebar-width) bg-transparent",
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon-sm"
      className={cn("inline-flex !inline-flex", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "hover:after:bg-sidebar-border absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] sm:flex",
...
function SidebarGroupLabel({
  ...
  return useRender({
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          "text-sidebar-foreground/70 ring-sidebar-ring h-8 rounded-md px-2 text-xs font-medium transition-[margin,opacity] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 flex shrink-0 items-center outline-hidden [&>svg]:shrink-0",
          className
        ),
      },
      props
...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "badge-notif badge-notif-danger pointer-events-none absolute right-1.5 top-1/2 -translate-y-1/2 tabular-nums select-none shadow-sm peer-data-[size=default]/menu-button:h-5 peer-data-[size=lg]/menu-button:h-5.5 peer-data-[size=sm]/menu-button:h-4.5 group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
    />
