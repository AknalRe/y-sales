...
// Types
// ====================
type TooltipProviderProps = React.ComponentProps<typeof BaseTooltip.Tooltip.Provider>;
type TooltipRootProps = React.ComponentProps<typeof BaseTooltip.Tooltip.Root>;
type TooltipTriggerProps = React.ComponentProps<typeof BaseTooltip.Tooltip.Trigger>;
type TooltipPortalProps = React.ComponentProps<typeof BaseTooltip.Tooltip.Portal>;
type TooltipPositionerProps = React.ComponentProps<typeof BaseTooltip.Tooltip.Positioner>;
type TooltipPopupProps = React.ComponentProps<typeof BaseTooltip.Tooltip.Popup>;
type TooltipArrowProps = React.ComponentProps<typeof BaseTooltip.Tooltip.Arrow>;
...
function TooltipProvider(props: TooltipProviderProps) {
  return (
    <BaseTooltip.Tooltip.Provider {...props} />
  );
}
...
function TooltipPortal(props: TooltipPortalProps) {
  return (
    <BaseTooltip.Tooltip.Portal {...props} />
  );
}
...
const TooltipPositioner = React.forwardRef<
  React.ElementRef<typeof BaseTooltip.Tooltip.Positioner>,
...
const TooltipPopup = React.forwardRef<
  React.ElementRef<typeof BaseTooltip.Tooltip.Popup>,
  TooltipPopupProps
>(({ className, ...props }, ref) => (
...
const TooltipArrow = React.forwardRef<
  React.ElementRef<typeof BaseTooltip.Tooltip.Arrow>,
  TooltipArrowProps
>(({ className, ...props }, ref) => (
  <BaseTooltip.Tooltip.Arrow
    ref={ref}
    {...props}
...
function ExampleTooltip() {
  return (
    ...
    <div className={styles.Panel}>
      <Tooltip>
        <TooltipTrigger aria-label="Bold" className={styles.Button}>
      ...
      <Tooltip>
        <TooltipTrigger aria-label="Italic" className={styles.Button}>
      ...
      <Tooltip>
        <TooltipTrigger aria-label="Underline" className={styles.Button}>
